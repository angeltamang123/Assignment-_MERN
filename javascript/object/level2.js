...
const str= person1.firstName+' '+person1.lastName;
console.log(str); 
...
const newObj = {...details1, ...details2};
console.log(newObj);
...
const keys=Object.keys(car4)

keys.includes('make') && keys.includes('model') && keys.includes('year')
...
let check=true
Object.entries(book9).forEach(item=>{
  check=true;
  if(!item[1]=='')
    {
      check=false;
...
let st= person10.fullName.split(' ').reverse().join(' ');
console.log(st)
